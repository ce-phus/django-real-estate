...
class UserAdmin(BaseUserAdmin):
    ...
    # list_display makes the id and email field clickable or linkable
    list_display_links= ['id', 'email']
    list_filter=['email', 'username', 'first_name', 'last_name', 'is_staff', 'is_active']
    # filedsets helps us to customise how the different sections of our admin panel will look like when we log in in our admin page
    fieldsets=(
        (
            _("login Credentials"),
            {
